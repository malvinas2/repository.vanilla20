...
##################################################
# Dialog window to find out if a video should be
...
class VideoExtrasResumeWindow(xbmcgui.WindowXMLDialog):
    ...
    def createVideoExtrasResumeWindow(resumetime=0):
        return VideoExtrasResumeWindow("script-videoextras-resume.xml", ADDON.getAddonInfo('path'), resumetime=resumetime)
